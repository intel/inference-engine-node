...
std::map<ie::Precision, std::string> precision_name_map = {
    {ie::Precision::FP32, "fp32"}, {ie::Precision::FP16, "fp16"},
    {ie::Precision::Q78, "q87"},   {ie::Precision::I32, "i32"},
    {ie::Precision::I16, "i16"},   {ie::Precision::I8, "i8"},
    {ie::Precision::U16, "u16"},   {ie::Precision::U8, "u8"}};

std::map<std::string, ie::Precision> precision_type_map = {
    {"fp32", ie::Precision::FP32}, {"fp16", ie::Precision::FP16},
    {"q78", ie::Precision::Q78},   {"i32", ie::Precision::I32},
    {"i16", ie::Precision::I16},   {"i8", ie::Precision::I8},
    {"i16", ie::Precision::U16},   {"u8", ie::Precision::U8}};
